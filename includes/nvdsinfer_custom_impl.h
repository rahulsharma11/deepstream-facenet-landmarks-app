...
extern "C"
 bool NvDsInferParseCustomYoloV4 (std::vector<NvDsInferLayerInfo> const &outputLayersInfo,
                                NvDsInferNetworkInfo const &networkInfo,
                                NvDsInferParseDetectionParams const &detectionParams,                                           std::vector<NvDsInferObjDetAdditionalMetaInfo> &objectList,
float ratio_w, float ratio_h, int muxer_output_width, int muxer_output_height, uint64_t frame_no, uint64_t camera_id);
